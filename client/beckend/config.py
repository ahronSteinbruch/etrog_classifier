...
class Config:
    ...
    BASE_URL = os.getenv("ETROG_B_BASE_URL", "http://localhost:8000")
    PATH_TEMPLATE = os.getenv("ETROG_B_STATUS_PATH", "/answer/{id}")
    DB_PATH = os.getenv("ETROG_SQLITE_PATH", "etrog_grades.db")
